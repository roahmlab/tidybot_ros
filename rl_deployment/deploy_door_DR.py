...
class RLDeployerNode(Node):
    def __init__(self):
        ...
        self.policy_path = 'door_full_DR.onnx'
        ...
        # Calibration Offsets
        delta_x, delta_y, delta_z = -0.01, 0.005, -0.05
        ...
        self.hinge_quat_w = np.array([0.70710678, -0.70710678, 0.0, 0.0], dtype=np.float32)
    ...
    def control_loop(self):
        ...
        if self.is_grasping or self.has_grasped_once:
            ...
            gripper_cooldown = max(gripper_cooldown, 0.3)
        else:
            door_pos = 0.0
