...
data_files=[
        ...
        ('share/' + package_name + '/urdf/', ['urdf/tidybot.xacro', 'urdf/bot.xacro', 'urdf/tidybot.ros2_control.xacro', 'urdf/tidybot.gazebo.xacro', 'urdf/arm.xacro', 'urdf/tidybot_hande_isaac.urdf', 'urdf/tidybot_2f_85_isaac.urdf']),
        ...
        ('share/' + package_name + '/meshes/grippers/robotiq_hande', glob('meshes/grippers/robotiq_hande/*.dae')),
...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'contact_force_publisher = tidybot_description.contact_force_publisher:main',
        ],
    },
)
