...
def generate_launch_description():
    ...
    # Compute use_sim as a string for the recorder (true if gazebo or isaac)
    use_sim_str = PythonExpression([
        "'true' if '", LaunchConfiguration("sim_mode"), "' != 'hardware' else 'false'"
    ])
